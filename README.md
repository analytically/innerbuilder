...
- Field name prefixes (e.g., `mFieldName` → `fieldName()` method)
...
- ⭐ [Star the project](https://github.com/analytically/innerbuilder) if you find it useful
- 🐛 [Report issues](https://github.com/analytically/innerbuilder/issues)
- 📝 [Rate on JetBrains Marketplace](https://plugins.jetbrains.com/plugin/7354-innerbuilder/)
